...
type UploadService interface {
	// 获取上传入口地址
	UploadEntry(ctx context.Context, in *UploadReqEntry, opts ...client.CallOption) (*UploadRespEntry, error)
}
...
func (c *uploadService) UploadEntry(ctx context.Context, in *UploadReqEntry, opts ...client.CallOption) (*UploadRespEntry, error) {
	req := c.c.NewRequest(c.name, "UploadService.UploadEntry", in)
	out := new(UploadRespEntry)
...
type UploadServiceHandler interface {
	// 获取上传入口地址
	UploadEntry(context.Context, *UploadReqEntry, *UploadRespEntry) error
}

func RegisterUploadServiceHandler(s server.Server, hdlr UploadServiceHandler, opts ...server.HandlerOption) error {
	type uploadService interface {
		UploadEntry(ctx context.Context, in *UploadReqEntry, out *UploadRespEntry) error
	}
	type UploadService struct {
		uploadService
	}
...
func (h *uploadServiceHandler) UploadEntry(ctx context.Context, in *UploadReqEntry, out *UploadRespEntry) error {
