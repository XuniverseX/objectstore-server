...
type DownloadService interface {
	// 获取下载入口地址
	DownloadEntry(ctx context.Context, in *DownloadReqEntry, opts ...client.CallOption) (*DownloadRespEntry, error)
}
...
func (c *downloadService) DownloadEntry(ctx context.Context, in *DownloadReqEntry, opts ...client.CallOption) (*DownloadRespEntry, error) {
	req := c.c.NewRequest(c.name, "DownloadService.DownloadEntry", in)
	out := new(DownloadRespEntry)
...
type DownloadServiceHandler interface {
	// 获取下载入口地址
	DownloadEntry(context.Context, *DownloadReqEntry, *DownloadRespEntry) error
}

func RegisterDownloadServiceHandler(s server.Server, hdlr DownloadServiceHandler, opts ...server.HandlerOption) error {
	type downloadService interface {
		DownloadEntry(ctx context.Context, in *DownloadReqEntry, out *DownloadRespEntry) error
	}
	type DownloadService struct {
		downloadService
	}
...
func (h *downloadServiceHandler) DownloadEntry(ctx context.Context, in *DownloadReqEntry, out *DownloadRespEntry) error {
